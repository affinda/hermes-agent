...
```powershell
& ([scriptblock]::Create((irm https://raw.githubusercontent.com/affinda/hermes-agent/affinda/slack-context-customization/scripts/install.ps1))) -NoVenv -SkipSetup -Branch affinda/slack-context-customization
```
